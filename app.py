...
def predict():
  ...
  if request.method == 'POST':
    ...
    PATH_TO_FROZEN_GRAPH = 'C:/2_My_Project/18_PotholeDetection_Mask_RCNN/place_in_object_detection/inference_graph/frozen_inference_graph.pb'
    PATH_TO_LABELS = 'C:/2_My_Project/18_PotholeDetection_Mask_RCNN/place_in_object_detection/training/label.pbtxt'
